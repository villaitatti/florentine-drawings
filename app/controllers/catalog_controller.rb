...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_show_field 'recto_title_1903_t', label: 'Recto Title (1903)'
    config.add_show_field 'recto_title_1938_t', label: 'Recto Title (1938)'
    config.add_show_field 'recto_title_1961_t', label: 'Recto Title (1961)'

    config.add_show_field 'recto_note_1903_t', label: 'Recto Note (1903)'
    config.add_show_field 'recto_note_1938_t', label: 'Recto Note (1938)'
    config.add_show_field 'recto_note_1961_t', label: 'Recto Note (1961)'

    config.add_show_field 'verso_title_1903_t', label: 'Verso Title (1903)'
    config.add_show_field 'verso_title_1938_t', label: 'Verso Title (1938)'
    config.add_show_field 'verso_title_1961_t', label: 'Verso Title (1961)'

    config.add_show_field 'verso_note_1903_t', label: 'Verso Note (1903)'
    config.add_show_field 'verso_note_1938_t', label: 'Verso Note (1938)'
    config.add_show_field 'verso_note_1961_t', label: 'Verso Note (1961)'

    config.add_show_field 'author_1903_display_s', label: 'Creator (1903)'
    config.add_show_field 'author_1938_display_s', label: 'Creator (1938)'
    config.add_show_field 'author_1961_display_s', label: 'Creator (1961)'

    config.add_show_field 'verso_figures_1903_t', label: 'Verso Figures (1903)'
    config.add_show_field 'verso_figures_1938_t', label: 'Verso Figures (1938)'
    config.add_show_field 'verso_figures_1961_t', label: 'Verso Figures (1961)'

    config.add_show_field 'recto_figures_1903_t', label: 'Recto Figures (1903)'
    ...
    config.add_sort_field 'score desc, has_image_i desc, pub_date_sort desc, title_sort asc', label: 'relevance'
